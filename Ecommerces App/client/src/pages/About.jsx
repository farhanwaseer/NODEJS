    ...
    <div className="row">                
      <div className="content-column col-lg-6 col-md-12 col-sm-12 order-2">
        <div className="inner-column">
          ...
          <div className="text">I am Farhan Waseer works at Css3 Transition since last 3 years. We are here to provide touch notch solution for your website or web application that helps you to make your website look attractive &amp; efficient in handling by creating usefull plugins thats you need.</div>
          <div className="text">
      ...
      <div className="image-column col-lg-6 col-md-12 col-sm-12">
        <div className="inner-column wow fadeInLeft">
          ...
          <figure className="image-1"><a href="#" className="lightbox-image" data-fancybox="images"><img title="farhan" src="https://cdn.pixabay.com/photo/2024/05/15/20/57/developer-8764521_1280.jpg" alt /></a></figure>
        </div>
      </div>
    </div>
    <div className="sec-title">
