      ...
      <section className="about-section">
        <div className="container">
          ...
          <div className="text">
            ...
            with proper stucture &amp; stunning looks which suits to your web
            app &amp; website.
          </div>
          <div className="text">
