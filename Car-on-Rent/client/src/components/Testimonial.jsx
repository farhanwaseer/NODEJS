...
const Testimonial = () => {
  const testimonials = [
    ...
    },
    {
      ...
      testimonial:
        "CarRental made my trip so much easier, The car war delivered right to my door, and the customer service was fantastic!",
    },
    {
      name: "Sofia Müller",
      ...
      image: assets.testimonial_image_1,
      testimonial:
        "Customer service was outstanding. I felt taken care of every step of the way.",
    },
  ];
